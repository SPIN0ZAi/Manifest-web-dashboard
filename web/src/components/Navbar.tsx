...
import { Search, BarChart3, Home, Menu, X, Gamepad2, LogIn, LogOut, ShieldCheck, Newspaper, Clock } from 'lucide-react';
...
export function Navbar() {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 bg-surface/85 backdrop-blur-md border-b border-white/5">
